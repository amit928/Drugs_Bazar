...
const styles = StyleSheet.create({
    ...
    form: {
        width: "90%", alignSelf: "center", backgroundColor: "#fff", borderRadius: 10, marginBottom: "17%", marginTop: "5%"
    },
    textInput: { width: "85%", display: "flex", alignSelf: "center", flexDirection: "row", borderColor: "gray", borderWidth: 0.7, padding: 7, borderRadius: 7, marginTop: "5%", paddingVertical: 9 },
    signInButton: {
