import { Image, KeyboardAvoidingView, SafeAreaView, StatusBar, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
                ...
                <SafeAreaView style={styles.body}>
                    ...
                    <View style={styles.form}>
                        ...
                        <View style={styles.textInput}>
                            <TextInput placeholder='User Name' placeholderTextColor={"gray"} style={{ width: "80%", marginLeft: "4%" }} onChangeText={(text) => this.setState({ userID: text })} />
                            <EvilIcons name="user" size={32} color="gray" />
                        </View>
                        <View style={styles.textInput}>
                            <TextInput placeholder='Password' placeholderTextColor={"gray"} style={{ width: "80%", marginLeft: "4%" }} onChangeText={(text) => this.setState({ password: text })} secureTextEntry />
...
const styles = StyleSheet.create({
    ...
    header: { width: "100%", height: "7%", alignSelf: "center", backgroundColor: "white", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" },
    imageStyle: { width: "95%", height: "35%", alignSelf: "center", position: "relative", display: "flex", alignItems: "center", justifyContent: "center" },
    form: {
        width: "90%", alignSelf: "center", position: "relative", backgroundColor: "#fff", borderRadius: 10, height: "55%"
    },

    textInput: { width: "85%", display: "flex", alignSelf: "center", flexDirection: "row", borderColor: "gray", borderWidth: 0.7, paddingHorizontal: 7, borderRadius: 7, marginTop: "4%", alignItems: "center" },
