...
const tableData = [
    ...
    { headerName: "Company ID", width: 90 },
    { headerName: "Package Name", width: 150 },
    { headerName: "PPack", width: 100 },
    { headerName: "Action", width: 80 }

]
class DistributorProduct extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        console.log(this.props.distributorsProductList.length)
        return (
            <View>
                <Header />
                <ScrollView>
                            ...
                            <View style={styles.tableBody}>
                                <ScrollView horizontal={true}  >
                                    <View style={{ borderRadius: 5 }}>
                                        ...
                                        <View>
                                            {
                                                this.props.distributorsProductList.length > 0 && this.props.distributorsProductList.map((item, index) => {
                                                    return (
                                                        <View key={index} style={{ flexDirection: "row", paddingVertical: 8, backgroundColor: index % 2 !== 0 ? "#e8e6ff" : "#fff", display: "flex", alignItems: "center" }}>
                                                            ...
                                                            <View style={{ width: 100, display: "flex", alignItems: "center" }}>
                                                                <Text style={{ fontSize: 12 }}>{item.sysprd}</Text>
                                                            </View>
...
export const mapStateToProps = (store) => {
    return {
        ...
        distributorsProductList: store.allInOneReducer.distributorsProductList,
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(DistributorProduct);
